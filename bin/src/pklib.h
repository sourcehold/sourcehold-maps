...
int PKEXPORT explode_nocb(unsigned char *pvOutBuffer, int * pcbOutBuffer, unsigned char *pvInBuffer, int cbInBuffer);

void PKEXPORT implode_nocb(unsigned char * pvOutBuffer, int * pcbOutBuffer, unsigned char * pvInBuffer, int cbInBuffer, int pCmpType, int nCmpLevel);
