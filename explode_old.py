...
if __name__ == "__main__":
    ...
    # dll = ctypes.CDLL("bin/compressionlib-bwapi.dll")
    dll = ctypes.CDLL("../IMPBORL.DLL")

    dll._implode.restype = ctypes.c_uint
    dll._implode.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.POINTER(ctypes.c_ubyte),
                             ctypes.POINTER(TDataInfo),
                             ctypes.POINTER(ctypes.c_uint), ctypes.POINTER(ctypes.c_uint)]

    dll._explode.restype = ctypes.c_int
    dll._explode.argtypes = [ctypes.c_void_p, ctypes.c_void_p, ctypes.POINTER(ctypes.c_ubyte),
                             ctypes.POINTER(TDataInfo)]
    ...
    if sys.argv[1] == "compress":
        ...
        # indata = (ctypes.c_ubyte * (len(data)+2))()
        ...
        # raise SystemExit
        result = dll._implode(read, write, work_buf, info, type, dsize)
        # print(result)
        ...
        result = dll._explode(read, write, work_buf, info)
        # print(result)
